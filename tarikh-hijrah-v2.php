...
$bulan_masihi=date('m');
$hari_masihi=(date('d')+$variance); //Boleh +-
$tahun_masihi=date('Y');
...
if($bulan_hijri==8){ $bulan_hijri = "Sya'ban";}
if($bulan_hijri==9){ $bulan_hijri = "Ramadhan";}
if($bulan_hijri==10){ $bulan_hijri = "Syawal";}
if($bulan_hijri==11){ $bulan_hijri = "Zulqaedah";}
if($bulan_hijri==12){ $bulan_hijri = "Zulhijjah";}

echo $hari_hijri.' '.$bulan_hijri.' '.$tahun_hijri;
